<%@ page import="com.mycompany.tictactoe3.TicTacToeBean" import="java.io.*" import="java.lang.Object" %>

<%@page language="java" contentType="text/html; charset=UTF-8" %>

<jsp:useBean id="game" class="com.mycompany.tictactoe3.TicTacToeBean" scope="session" />
<html lang="en"
